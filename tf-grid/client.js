...
var Client = require('tfgrid-api-client');
var contracts_1 = require("./contracts");
var TFClient = /** @class */ (function () {
    function TFClient(url, mnemonic) {
        this.client = new Client(url, mnemonic);
        this.contracts = new contracts_1.Contracts(this.client);
    }
    TFClient.prototype.connect = function () {
    ...
    TFClient.prototype.disconnect = function () {
