...
function getNodeTwinId(node_id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield send("post", graphqlURL, JSON.stringify({ query: body }), headers);
...
function getAccessNodes() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const nodeResponse = yield send("post", graphqlURL, JSON.stringify({ query: body }), headers);
        ...
        const pubConfigResponse = yield send("post", graphqlURL, JSON.stringify({ query: body }), headers);
...
function getNodeIdFromContractId(contractId, url, mnemonic) {
    return __awaiter(this, void 0, void 0, function* () {
