...
class MachineModule extends base_1.BaseModule {
    ...
    async getPrettyObj(deploymentName) {
        ...
        return workloads.map(workload => this._getZMountData(deployments, workload));
    }
    async get(options) {
    ...
    async update(options) {
        ...
        const workload = this._getWorkloadsByType(oldDeployments, workload_1.WorkloadTypes.zmachine)[0];
