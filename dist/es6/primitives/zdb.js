...
class ZdbPrimitive {
    create(name, size, mode = ZdbModes.seq, password, pub, metadata = "", description = "", version = 0) {
        const zdb = new Zdb();
        zdb.size = size;
        zdb.mode = mode;
    ...
    update(name, size, mode = ZdbModes.seq, password, pub, metadata = "", description = "", version = 1) {
